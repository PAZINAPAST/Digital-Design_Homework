...
set_property -dict { PACKAGE_PIN F15   IOSTANDARD LVCMOS33 } [get_ports { spi_clk }]; #IO_L14P_T2_SRCC_15 Sch=acl_sclk
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { spi_cs_n }]; #IO_L12P_T1_MRCC_15 Sch=acl_csn
